...
// Service names
var IPA_DIALOG_NAME = "traveldialog1"; // REPLACE with your own name
var IPA_CLASSIFIER_NAME = "demo_ipa";  // NO NEED TO RENAME THIS ONE unless you want to

// Intent Types
var INTENT_TYPE_DIALOG_LOCATION = "location";
// var INTENT_TYPE_DIALOG_SCHEDULE = "schedule";
// var INTENT_TYPE_DIALOG_LOST = "lost";
// var INTENT_TYPE_DIALOG_FOUND = "found";
...
function getReplyToIntent(nlcResponse, userText)
{
    ...
    switch (intentType) {
        case INTENT_TYPE_DIALOG_LOCATION:
            break;
        // case INTENT_TYPE_DIALOG_SCHEDULE:
        //     break;
        // case INTENT_TYPE_DIALOG_LOST:
        //     break;
        // case INTENT_TYPE_DIALOG_FOUND:
        //     break;
...
function isDialogRequiredIntent() {
    return intentType == INTENT_TYPE_DIALOG_LOCATION;
    // || intentType == INTENT_TYPE_DIALOG_SCHEDULE || intentType == INTENT_TYPE_DIALOG_LOST || intentType == INTENT_TYPE_DIALOG_FOUND;
}
